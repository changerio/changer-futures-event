...
export enum SUBGRAPHS {
  ...
  // arbitrum = 'https://api.studio.thegraph.com/query/56479/gambit-zksync/v0.1.20-rc1'
  arbitrum = 'https://api.studio.thegraph.com/proxy/47348/gambit-zksync-alpha/version/latest'
}